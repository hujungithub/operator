...
<div class="je-p20">
            ...
            <div class="je-form-item">
                <div class="je-w33 je-dib" >
                    ...
                    <div class="je-inputbox" style="">
                    	<input id="CPUSERNAME" name="CPUSERNAME" class="je-input"/>
                    </div>
                </div>
                <div class="je-w33 je-dib">
                    <label class="je-label je-f14">电话:</label>
                    <div class="je-inputbox" style="">
                     	<input id="TELEPHONE" name="TELEPHONE" class="je-input"/>
                    </div>
                </div>
            </div>
             <div class="je-form-item">
                <div class="je-w33 je-dib">
                    ...
                    <div class="je-inputbox" style="">
                        <input id="ADDRESS" name="ADDRESS" class="je-input"/>
                    </div>
                </div>
                <div class="je-w33 je-dib" >
                    <label class="je-label je-f14">邮箱:</label>
                    <div class="je-inputbox" style="" id="addselect">
                        <input id="EMAIL" name="EMAIL" class="je-input"/>
                    </div>
                </div>
            </div>
	...
	function updateDATA(data) {
		$("#CPUSERNAME").val(data.cpusername);
