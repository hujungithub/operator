...
<body >
  <div class="" style="background-color:white!important; border-radius:5px; padding:10px;">
      ...
      <form action="" id="search-form">
      			...
      			<span>桩状态:</span> 
      				<input data-column="2" id="search5" name="CPSTATE" type="text" class="search"/>
      			<span>枪状态:</span> 
      				<input data-column="5" id="search6" name="GUNSTATE" type="text" class="search"/>
      			</div>
				<span>记录时间:</span> 
...
function getDataFromServer(){
  ...
  $.ajax({
      "url":"http://localhost:8081/qianfeng/chargeView/findData",//后台接口
      "data":{
    	  "CPTYPE":"0"
      }, 
      "type":"GET",
