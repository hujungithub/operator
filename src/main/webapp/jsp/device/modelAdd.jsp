                ...
                <div class="je-w33 je-dib">
                    <label class="je-label je-f14">厂&nbsp&nbsp&nbsp商:</label>
                   	 <select class="my-select je-select" id="MFRID" name="MFRID"
                        		style="width:61%;height:32px">
						<option value="">请选择厂商</option>
                       	<c:forEach items="${mfrnameList }" var="list">
                       		<option value="${list.MFRID}">${list.MFRNAME }</option>
                       	</c:forEach>
					</select>
                </div>
                <div class="je-w33 je-dib">
             	 ...
             	 <div class="je-w33 je-dib">
	                    ...
	                    <div class="je-inputbox" style="">
	                       	<select class="my-select je-select" id="INTERFACECOUNT" name="INTERFACECOUNT"
									...
									<option value="">请选择类型</option>
									<option value="1">单枪</option>
									<option value="2">双枪</option>
							</select>
                    	</div>
                </div>
                <div class="je-w33 je-dib" >
