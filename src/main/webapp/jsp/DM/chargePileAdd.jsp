		...
		<form action="" id="add_form">
            <div class="je-form-item">
                <div class="je-w33 je-dib">
                    ...
                    <div class="je-inputbox" style="">
                        <select id="OPERATORID" name="OPERATORID" class="my-select je-select" 
                        		style="width:100%;height:32px" onchange="select_CS(this);">
            ...
            <div class="je-form-item">
                <div class="je-w33 je-dib">
                    ...
                    <div class="je-inputbox" style="">
                        <input type="text" name="CPNAME" id="CPNAME" class="my-input je-input">
                    </div>
                </div>
                <div class="je-w33 je-dib" >
                    <label class="je-label je-f14">设备号:</label>
                    <div class="je-inputbox" style="">
            ...
            <div class="je-form-item">
                <div class="je-w33 je-dib">
                    <label class="je-label je-f14">协议:</label>
                    <div class="je-inputbox" style="">
                        <select class="my-select je-select" id="PROTOCOLID" name="PROTOCOLID"
                        		style="width:100%;height:32px">
							<option value="">请选择协议</option>
							<c:forEach items="${infoList}" var="tocol">
