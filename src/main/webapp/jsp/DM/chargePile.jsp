      ...
      table = $('#example').DataTable({
         ...
         },
         {
             "render": function(data, type, row, meta) {
                 ...
                 return '<a href="jsp/DM/chargePileDetail.jsp?CPID=' + row.cpid + '&OPERATORLOGINID='+operatorloginid+'" style="color:#0095d9">' + row.cpname + '</a>';
             },
             //指定是第三列
             "targets": 2
         },{
    ...
    function update(id){
      ...
      jeBox.open({
        ...
        content: ['<%=basePath%>jsp/DM/chargePileUpdate.jsp?operatorloginid=' 
      		  + operatorloginid + '&CPID=' + id,'yes']
     	});
    };
    
    function detail(id){
    	var operatorloginid = $("#OPERATORLOGINID").val();
    	window.location.href='jsp/DM/chargePileDetail.jsp?CPID='+id+"&OPERATORLOGINID="+operatorloginid;
    }
  </script>
</html>