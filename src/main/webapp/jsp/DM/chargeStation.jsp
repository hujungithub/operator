  ...
  <div class="" style="background-color:white!important; border-radius:5px; padding:10px;">
      ...
      <form action="" id="search-form">
      			...
      			<label><span style="width:100px">地址:</span></label>
      				<input data-column="4" id="search4" name="LOCATION" type="text" class="search"/>
      			<span>运营商:</span> 
      				<input data-column="3" id="search3" name="OPERATORID" type="text" class="search"/>
      			<span>充电站:</span> 
      				<input data-column="2" id="search2" name="CSNAME" type="text" class="search"/>
      			</div>
				<span>建站日期:</span> 
				...
				<div class="home-label home-label-font margin-right add-wrap">
		          <shiro:hasPermission name="chargestation:add">
			          <button type="button" id="add-btn" class="je-btn je-bg-orange je-rdu">新建充电站</button>
			      </shiro:hasPermission>
			      <shiro:hasPermission name="chargestation:delete">
      ...
      table = $('#example').DataTable({
         ...
         },
         {
             "render": function(data, type, row, meta) {
                 ...
                 return '<a href="jsp/DM/chargeStationDetail.jsp?CSID=' + row.csid + '&OPERATORLOGINID='+operatorloginid+'" style="color:#0095d9">' + row.csname + '</a>';
             },
             //指定是第三列
             "targets": 2
         },{
  ...
  return data;
    ...
    function update(id){
      ...
      jeBox.open({
        ...
        content: ['<%=basePath%>jsp/DM/chargeStationUpdate.jsp?operatorloginid=' 
      		  + operatorloginid + '&CSID=' + id,'yes']
     	});
	}
	
    function detail(id){
    	var operatorloginid = $("#OPERATORLOGINID").val();
    	window.location.href='jsp/DM/chargeStationDetail.jsp?CSID='+id+"&OPERATORLOGINID="+operatorloginid;
    }
  </script>
</html>