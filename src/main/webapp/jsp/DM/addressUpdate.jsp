...
<div class="je-p20">
		<form action="" id="add_form">
            ...
            <div class="je-form-item">
                ...
                <div class="je-w33 je-dib" >
                    <label class="je-label je-f14">经度:</label>
                    <div class="je-inputbox" style="">
                       <input type="text" name="LONGITUDE" id="LONGITUDE" class="my-input je-input" value="" />
                    </div>
                </div>
            </div>
            <div class="je-form-item">
                <div class="je-w33 je-dib" >
                    <label class="je-label je-f14">纬度:</label>
                    <div class="je-inputbox" style="">
                       <input type="text" name="LATITUDE" id="LATITUDE" class="my-input je-input" value="" />
                    </div>
                </div>
            </div>
             <div class="je-form-item" >
			...
			<input id="ADDRESSID" name="ADDRESSID" type="hidden" value="<%=request.getParameter("ADDRESSID")%>">
		</form>
	...
	$(document).ready(function(){
		...
		$.ajax({
			"type":"post",
			"url":"address/findUpdateAddressData",
			"data":{
				"ADDRESSID":ADDRESSID
			},
		 	"dataType":"json", 
	...
	function updateLOC(data) {
		...
		$("#ADDRESSNAME").val(addressDto.addressname);
		$("#LONGITUDE").val(addressDto.longitude);
		$("#LATITUDE").val(addressDto.latitude);
	};
