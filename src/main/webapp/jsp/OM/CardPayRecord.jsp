...
<body >
  <div class="" style="background-color:white!important; border-radius:5px; padding:10px;">
      <div class="h2 bgColor">
        <a style="text-decoration:underline">卡充值纪录</a>
      </div>
      <div class="searchbox h2">
      <form action="" id="search-form">
      			<div>
      			<label><span style="width:100px">卡号:</span></label>
      				<input data-column="1" id="search1" name="CARDNUM" type="text" class="search"/>
      			<span>运营商：</span> 
      				<input data-column="7" id="search7" name="OPERATORNAME" type="text" class="search" />
      			<span>充值结果：</span> 
      				<input data-column="5" id="search5" name="RECHARGERESULT" type="text" class="search" />
      			</div>
				<span>充值时间:</span> 
...
function getDataFromServer(){
  ...
  $.ajax({
      "url":"userCard/findRechargeRecordFirst",//后台接口
      "data":{
