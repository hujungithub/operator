...
<body >
  <div class="" style="background-color:white!important; border-radius:5px; padding:10px;">
      <div class="h2 bgColor">
        <a style="text-decoration:underline">APP充值纪录</a>
      </div>
      <div class="searchbox h2">
      <form action="" id="search-form">
      			<div>
      			<label><span style="width:100px">用户名:</span></label>
      				<input data-column="1" id="search1" name="CPUSERNAME" type="text" class="search"/>
      			<span>手机号码：</span> 
      				<input data-column="2" id="search2" name="TELEPHONE" type="text" class="search" />
      			</div>
				<span>充值日期:</span> 
				...
				<div class="home-label home-label-font margin-right add-wrap">
				  <shiro:hasPermission name="appchargerecord:import">
...
function getDataFromServer(){
  ...
  $.ajax({
      "url":"cpUser/findAPPUCFirst",//后台接口
      "type":"GET",
      "data":{
