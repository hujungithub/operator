...
<body >
  <div class="" style="background-color:white!important; border-radius:5px; padding:10px;">
      <div class="h2 bgColor">
        <a style="text-decoration:underline">微信充值记录</a>
      </div>
      <div class="searchbox h2">
      <form action="" id="search-form">
      			<div>
      			<label><span style="width:100px">订单号:</span></label>
      				<input data-column="1" id="search1" name="TRANSACTIONNUM" type="text" class="search"/>
      			<span>用户id：</span> 
      				<input data-column="2" id="search2" name="USERID" type="text" class="search" />
      			<span>订单状态：</span> 
      				<input data-column="7" id="search7" name="RECHARGERESULT" type="text" class="search" />
      			</div>
				<span>充值时间:</span> 
...
$(document).ready(function() {
       ...
       /* $("#export-btn").on("click",function(){
    	   ...
    	   $("#search-form").attr("action","userCard/userCardRechargeExport");
		   $("#search-form").submit();
       }); */
...
function getDataFromServer(){
  ...
  $.ajax({
      "url":"wechat/findWeChatPayFirst",//后台接口
      "data":{
