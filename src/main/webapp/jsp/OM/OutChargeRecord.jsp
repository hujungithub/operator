...
<body >
  <div class="" style="background-color:white!important; border-radius:5px; padding:10px;">
      <div class="h2 bgColor">
        <a style="text-decoration:underline">外部充电记录</a>
      </div>
      <div class="searchbox">
      	<form id="search-form">
      		...
      		<div style="float: left">
		        ...
		        <input class="datainp wicon" id="inpstart" type="text" name="FROMDATE" placeholder="开始日期" value=""  readonly>
		         ——
		        <input class="datainp wicon" id="inpend" type="text" name="TODATE" placeholder="结束日期" value=""  readonly>
      		</div>
...
$.fn.dataTable.ext.search.push(
    function( settings, data, dataIndex ) {
        ...
        var date = data[8]; // use data for the age column
        if ( 
             (inpstart=="" && inpend=="") ||
...
function getDataFromServer(){
  ...
  $.ajax({
      "url":"userreports/findExternalUCRFirst",//后台接口
      "data":{
