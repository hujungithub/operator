...
public class CPYXRunRecord_104 {

	private String ID;// id
	private String CPID;// 桩id
	private int YXPOINTID;// 遥信
	...
	public String toString() {
		return "CPYXRunRecord [ID=" + ID + ", CPID=" + CPID + ", YXPOINTID="
				+ YXPOINTID + ", RECORDTIME=" + RECORDTIME + ", OLDVALUE="
				+ OLDVALUE + ", OLDVALUEMEAN=" + OLDVALUEMEAN
