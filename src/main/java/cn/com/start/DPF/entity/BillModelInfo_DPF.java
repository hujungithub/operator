...
public class BillModelInfo_DPF {
	private int OPERATORID;
	private int RATEID;// 套 1-4
	private int BILLMODELID;// 模板 1-12
	private String VALIDTIME;// 生效时间 一般一个月
	private String INVALIDTIME;// 失效时间
	private int TIMEINTERVALCOUNT; // 时段数
	private float JPRICE;// 尖电价
	private float FPRICE;// 峰电价
	private float PPRICE;// 平电价
	...
	public String toString() {
		return "BillModelInfo_DPF [OPERATORID=" + OPERATORID + ", RATEID="
				+ RATEID + ", BILLMODELID=" + BILLMODELID + ", VALIDTIME="
				+ VALIDTIME + ", INVALIDTIME=" + INVALIDTIME
				+ ", TIMEINTERVALCOUNT=" + TIMEINTERVALCOUNT + ", JPRICE="
				+ JPRICE + ", FPRICE=" + FPRICE + ", PPRICE=" + PPRICE
				+ ", GPRICE=" + GPRICE + ", SERVICETIP=" + SERVICETIP
				+ ", TI_1_START=" + TI_1_START + ", TI_1_ID=" + TI_1_ID
				+ ", TI_2_START=" + TI_2_START + ", TI_2_ID=" + TI_2_ID
				+ ", TI_3_START=" + TI_3_START + ", TI_3_ID=" + TI_3_ID
				+ ", TI_4_START=" + TI_4_START + ", TI_4_ID=" + TI_4_ID
				+ ", TI_5_START=" + TI_5_START + ", TI_5_ID=" + TI_5_ID
				+ ", TI_6_START=" + TI_6_START + ", TI_6_ID=" + TI_6_ID
				+ ", TI_7_START=" + TI_7_START + ", TI_7_ID=" + TI_7_ID
				+ ", TI_8_START=" + TI_8_START + ", TI_8_ID=" + TI_8_ID + "]";
	}
