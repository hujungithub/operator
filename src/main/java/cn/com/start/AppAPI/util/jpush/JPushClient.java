...
import cn.com.start.AppAPI.util.jpush.audience.Audience;
import cn.com.start.AppAPI.util.jpush.device.AliasDeviceListResult;
import cn.com.start.AppAPI.util.jpush.device.DeviceClient;
import cn.com.start.AppAPI.util.jpush.device.OnlineStatus;
import cn.com.start.AppAPI.util.jpush.device.TagAliasResult;
import cn.com.start.AppAPI.util.jpush.device.TagListResult;
import cn.com.start.AppAPI.util.jpush.notification.IosAlert;
import cn.com.start.AppAPI.util.jpush.notification.Notification;
import cn.com.start.AppAPI.util.jpush.report.MessagesResult;
import cn.com.start.AppAPI.util.jpush.report.ReceivedsResult;
import cn.com.start.AppAPI.util.jpush.report.ReportClient;
import cn.com.start.AppAPI.util.jpush.report.UsersResult;
import cn.com.start.AppAPI.util.jpush.schedule.ScheduleClient;
import cn.com.start.AppAPI.util.jpush.schedule.ScheduleListResult;
import cn.com.start.AppAPI.util.jpush.schedule.ScheduleResult;
import cn.com.start.AppAPI.util.jpush.schedule.model.SchedulePayload;
import cn.com.start.AppAPI.util.jpush.schedule.model.TriggerPayload;
