...
import cn.com.start.AppAPI.util.jpush.audience.AudienceTarget;
import cn.com.start.AppAPI.util.jpush.notification.AndroidNotification;
import cn.com.start.AppAPI.util.jpush.notification.InterfaceAdapter;
import cn.com.start.AppAPI.util.jpush.notification.IosAlert;
import cn.com.start.AppAPI.util.jpush.notification.IosNotification;
import cn.com.start.AppAPI.util.jpush.notification.Notification;
import cn.com.start.AppAPI.util.jpush.notification.PlatformNotification;
...
//    protected static final Logger LOG = LoggerFactory.getLogger(PushExample.class);
	...
	private static final String appKey ="3a914db9014b27caeed7be6c";
	private static final String masterSecret = "b02de8edc72cf76c697125f9";
...
//            LOG.info("Msg ID: " + e.getMsgId());
    ...
    public static void testSendPushWithCustomConfig(PushPayload payload) {
