...
public class BillModelInfo_API {
	...
	public String toString() {
		return "BillModelInfo [RATEID=" + RATEID + ", BILLMODELID="
				+ BILLMODELID + ", VALIDTIME=" + VALIDTIME + ", INVALIDTIME="
				+ INVALIDTIME + ", TIMEINTERVALCOUNT=" + TIMEINTERVALCOUNT
				+ ", JPRICE=" + JPRICE + ", FPRICE=" + FPRICE + ", PPRICE="
				+ PPRICE + ", GPRICE=" + GPRICE + ", TI_1_START=" + TI_1_START
				+ ", TI_1_ID=" + TI_1_ID + ", TI_2_START=" + TI_2_START
				+ ", TI_2_ID=" + TI_2_ID + ", TI_3_START=" + TI_3_START
				+ ", TI_3_ID=" + TI_3_ID + ", TI_4_START=" + TI_4_START
				+ ", TI_4_ID=" + TI_4_ID + ", TI_5_START=" + TI_5_START
				+ ", TI_5_ID=" + TI_5_ID + ", TI_6_START=" + TI_6_START
				+ ", TI_6_ID=" + TI_6_ID + ", TI_7_START=" + TI_7_START
				+ ", TI_7_ID=" + TI_7_ID + ", TI_8_START=" + TI_8_START
				+ ", TI_8_ID=" + TI_8_ID + "]";
	}
